        ...
        <div className="h-full mx-auto flex justify-center items-center px-10 sm:w-3/4">
          <div className="border w-full flex flex-col p-10 gap-8 rounded">
            ...
            <form className="flex flex-col gap-8">
                <Input className="h-12" placeholder="Username" />
                ...
                <Button className="w-full bg-[#019b98] hover:bg-[#55ccc9]">SignUp</Button>
                <p className="text-gray-400 text-sm">or</p>
                <Button className="w-full bg-[#014e60] hover:bg-[#3f7a8d]">Login</Button>
                </span>
            </form>
